  ...
  <nav class="navbar navbar-expand-lg bg-primary text-white">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <ul class="navbar-menu d-flex d-none d-lg-flex">
        ...
        <li>
          <router-link to="/catalogbook" :class="{ active: $route.path === '/catalogbook' }">Danh Mục Sách</router-link>
        </li>
        <li>
          <router-link to="/borrowinghistory" :class="{ active: $route.path === '/borrowinghistory' }">Lịch Sử Mượn</router-link>
        </li>
      </ul>
        ...
        <div class="mobile-menu d-lg-none">
          ...
          <div v-if="showMobileMenu" class="mobile-dropdown bg-white text-dark shadow rounded p-3">
            ...
            <div v-if="$route.path !== '/'" class="mt-2">
              <input type="text" placeholder="Tìm kiếm ..." class="form-control mb-2" />
