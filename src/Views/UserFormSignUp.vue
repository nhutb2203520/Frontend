<template>
      ...
      <div class="signup-form">
        ...
        <form @submit.prevent="submitRegister">
          ...
          <div>
            ...
            <input type="tel" id="sdt" v-model="registerData.DIENTHOAI" required pattern="[0-9]{10}" placeholder="10 chữ số" />
          </div>
  
          <!-- Email -->
          <div>
            <label for="email">Email:</label>
            <input type="email" id="email" v-model="registerData.EMAIL" required pattern="^[^\\s@]+@[^\\s@]+\\.[^\\s@]{2,}$" placeholder="Nhập mail của bạn " />
          </div>
  
          <!-- Mật khẩu -->
          <div>
            <label for="password">Mật Khẩu:</label>
            <input type="password" id="password" v-model="registerData.PASSWORD" required placeholder="Nhập mật khẩu" />
          </div>
  
          <!-- Nhập lại mật khẩu -->
          <div>
            <label for="confirm">Nhập Lại Mật Khẩu:</label>
            <input type="password" id="confirm" v-model="registerData.CONFIRM_PASSWORD" required placeholder="Nhập lại mật khẩu" />
          </div>
  ...
  <style src="@/assets/sign.css"></style>